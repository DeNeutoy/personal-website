...
summary: 'Paper review of Barlow Twins: Self-Supervised Learning via Redundancy Reduction'
---
...
<Image
  alt={`architecture for barlow twins paper`}
  src={`/images/paper_reviews/barlow_twins/arch.png`}
  width={1600}
  height={840}
/>
...
<Image
  alt={`augmentations plot for barlow twins paper`}
  src={`/images/paper_reviews/barlow_twins/augmentations.png`}
  width={1600}
  height={840}
/>
...
<Image
  alt={`dim graph for barlow twins paper`}
  src={`/images/paper_reviews/barlow_twins/dimensionality.png`}
  width={1600}
  height={840}
/>
