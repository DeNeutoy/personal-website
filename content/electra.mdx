---
title: 'Paper Review: Electra'
publishedAt: '2021-07-19'
summary: 'ELECTRA: Pre-training text encoders as discriminators rather than generators'
---
...
<Image
  alt={`network for electra paper`}
  src={`/images/paper_reviews/electra/network.png`}
  width={1600}
  height={840}
/>
