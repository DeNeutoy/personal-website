...
<Image
alt={"astoria column"}
src={"/images/sf_roadtrip/astoriacolumn.jpeg"}
width={500}
height={440}
/>
...
<Image
alt={`snake`}
src={`/images/sf_roadtrip/snake.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`salamander`}
src={`/images/sf_roadtrip/salamander.jpeg`}
width={500}
height={440}
/>
...
We left Salem in the morning to head to Bend - on the way we did the 10 waterfalls hike at [Silver Falls State Park](https://maps.app.goo.gl/B5wwFqEE3zSv9QYT6), which may be in my top 10 hikes ever - mainly due to the high density of waterfalls compared to the otherwise quite easy hike.


<Image
alt={`waterfall`}
src={`/images/sf_roadtrip/waterfall.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`waterfall`}
src={`/images/sf_roadtrip/waterfall2.jpeg`}
width={500}
height={440}
/>


 We then headed to Bend, where we had dinner and a few beers at [Deshutes Brewery](https://maps.app.goo.gl/hBGUiBnuKFPjYWXY8), which had a cool pub vibe, and a good selection of beers that you can't get in stores.

### Day 5 - Bend

Today we had a bit of a rest day in Bend - in the morning, we walked the [Deschutes River Trail](https://maps.app.goo.gl/nh4LwmyYj46Q1TCUA), which was a very pleasant out and back along both sides of the river.  Afterward, we went to the [Deschutes Historical Museum](https://maps.app.goo.gl/iLfGVHPg5h79KnHq8) which had a great exhibit about the history of mountain biking in Bend, and only cost about $6. Afterward, we went to [Spork](https://maps.app.goo.gl/bmfgVR9wKyYYaVac6) for dinner, which was a counter service asian food place, with quite down to earth service but very good food.


<Image
alt={`bend`}
src={`/images/sf_roadtrip/bend.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`crater lake`}
src={`/images/sf_roadtrip/craterlake2.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`jacksonville`}
src={`/images/sf_roadtrip/jacksonville2.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`caves`}
src={`/images/sf_roadtrip/caves.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`california sign`}
src={`/images/sf_roadtrip/cali.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`fern wall`}
src={`/images/sf_roadtrip/fernwall.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`harbor house inn`}
src={`/images/sf_roadtrip/harbourhouse.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`harbor house inn`}
src={`/images/sf_roadtrip/harbourhouse2.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`abalone`}
src={`/images/sf_roadtrip/abalone.jpeg`}
width={500}
height={440}
/>
...
<Image
alt={`sonoma`}
src={`/images/sf_roadtrip/sonoma.jpeg`}
width={500}
height={440}
/>
...
The full list of places we went to/stayed at is in this [Google Maps List](https://maps.app.goo.gl/ipjkqgsNKfUt1zf18) - enjoy!