---
title: 'Paper Review: No Explainability without Accountability'
publishedAt: '2021-07-19'
summary: 'No Explainability without Accountability: An Empirical Study of Explanations and Feedback in Interactive ML'
---
...
<Image
  alt={`setup`}
  src={`/images/paper_reviews/interpret/setup.png`}
  width={1600}
  height={840}
/>
...
<Image
  alt={`expected improvement`}
  src={`/images/paper_reviews/interpret/improvement.png`}
  width={1600}
  height={840}
/>
...
### Explicitly modelling interaction
