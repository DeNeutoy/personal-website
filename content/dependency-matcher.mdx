---
title: 'The Spacy DependencyMatcher'
publishedAt: '2021-07-19'
summary: 'Use cases for the little publicized Spacy dependency path matcher.'
---
...
<Image
  alt={`Dependency Subtrees`}
  src={`/images/dependency_matcher/dependency_paths.png`}
  width={1600}
  height={840}
/>
